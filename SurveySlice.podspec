#
#  Be sure to run `pod spec lint SurveySlice.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Chris Allan Li" => "me@chrisallanli.com" }
  ...
  s.source_files  = "SurveySlice/**/*.{swift}"
  ...
  s.resources = "SurveySlice/**/*.{png,jpeg,jpg,storyboard,xib}"
